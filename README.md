> Independent VAD code, notebook, and tests were retired on 2026-09-08.
> See [retirement location, ledger, and recovery instructions](RETIRED_VAD.md).
> SER, IEMOCAP compatibility code, research plans, and saved assets remain here.
...
## Retired VAD notebook

The independent VAD notebook and its implementation are stored outside this
repository. See [RETIRED_VAD.md](RETIRED_VAD.md) for the location, file ledger,
and restoration instructions. Existing runs and feature caches remain in place.
